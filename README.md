...
=======
2. Switch to the Beta Version of Garfield Kart (multi_test) in Steam Game properties.

3. Locate the Assembly-CSharp.dll in your Garfield Kart Folder
  - `C:\Program Files (x86)\Steam\steamapps\common\Garfield Kart\Garfield_Master7_Data\Managed`
4. Replace the Assembly-CSharp.dll with the one downloaded in [Step 1](/downloads/latest/Assembly-CSharp.dll).

>>>>>>> e52bfb8... Fixed README.md
5. Have fun!
